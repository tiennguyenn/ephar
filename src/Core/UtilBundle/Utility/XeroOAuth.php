...
use UtilBundle\Utility\OAuthSimple;
...
class XeroOAuth {
	...
	function __construct($config) {
		...
		$base_path =   $config['xero_base_path_cert'];//'D:\projects\gmed\web';
		...
		$this->_xero_curl_options = array ( // you probably don't want to change any of these curl values
				...
				'curl_cainfo' => $base_path . '/ca-bundle.crt',
