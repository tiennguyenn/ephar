 ...
 *
 * @ORM\Table(name="platform_share_percentages")
 * @ORM\Entity(repositoryClass="UtilBundle\Repository\PlatformSharePercentagesRepository")
 */
class PlatformSharePercentages
{
    /**
     * @var integer
     *
     ...
     * @var float
     *
     * @ORM\Column(name="doctor_percentage", type="float", precision=10, scale=0, nullable=false)
     */
    private $doctorPercentage;

    /**
     * @var float
     *
     * @ORM\Column(name="new_doctor_percentage", type="float", precision=10, scale=0, nullable=true)
     */
    private $newDoctorPercentage;
     ...
     * @return PlatformSharePercentages
     */
    ...
    /**
     * Set doctorPercentage
     *
     * @param float $doctorPercentage
     * @return PlatformSharePercentages
     */
    public function setDoctorPercentage($doctorPercentage)
    {
     ...
     * @return float 
     */
    public function getDoctorPercentage()
    {
        return $this->doctorPercentage;
    }

    /**
     * Set newDoctorPercentage
     *
     * @param float $newDoctorPercentage
     * @return PlatformSharePercentages
     */
    public function setNewDoctorPercentage($newDoctorPercentage)
    {
        $this->newDoctorPercentage = $newDoctorPercentage;

        return $this;
    }

    /**
     * Get newDoctorPercentage
     *
     * @return float 
     */
    public function getNewDoctorPercentage()
    {
        return $this->newDoctorPercentage;
    }
