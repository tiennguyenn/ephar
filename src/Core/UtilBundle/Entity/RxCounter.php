 ...
 * RxIssueCounter
 *
 * @ORM\Table(name="rx_counter", uniqueConstraints={@ORM\UniqueConstraint(name="IDX_rx_counter_onumber", columns={"rx_id"})})
 * @ORM\Entity(repositoryClass="UtilBundle\Repository\RxCounterRepository")
