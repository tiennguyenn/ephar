...
/**
 * AgentMonthlyStatement
 *
 * @ORM\Table(name="agent_monthly_statement")
 * @ORM\Entity(repositoryClass="UtilBundle\Repository\AgentMSRepository")
 */
class AgentMonthlyStatement
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="total_invoice_amount", type="decimal", precision=13, scale=2, nullable=true)
     */
    ...
    /**
     *
     * @ORM\OneToMany(targetEntity="AgentMonthlyStatementLine", mappedBy="agentMonthlyStatement", cascade={"persist", "remove"})
     */
    private $lines;
    ...
    /**
     * @var AgentMonthlyStatementLine
     */
    public function addLine(AgentMonthlyStatementLine $line)
    {
        $line->setAgentMonthlyStatement($this);
        $this->lines->add($line);
    }
