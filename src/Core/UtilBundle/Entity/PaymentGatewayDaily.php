 ...
 * PaymentGatewayDaily
 *
 * @ORM\Table(name="payment_gateway_daily")
 * @ORM\Entity(repositoryClass="UtilBundle\Repository\PaymentGatewayDailyRepository")
 */
class PaymentGatewayDaily
{
    /**
     * @var integer
     *
