...
use UtilBundle\Entity\PaymentGatewayWeekly;
use UtilBundle\Utility\Common;
use UtilBundle\Utility\Constant;
use UtilBundle\Utility\Utils;

/**
 * PaymentGatewayWeeklyRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class PaymentGatewayWeeklyRepository extends EntityRepository
{
    /**
     * create new
     */
     ...
     * set data weekly
     */
    public function setDataWeekly($date)
    {
        ...
        if($result) {
            ...
            $period = Common::getWeekPeriod($date);
            $expectedSettlementDate = Utils::getWorkingDate($listPHDate, 6, $period['end']);

            $params = array(
                'startPeriod' => $period['start'],
                'endPeriod' => $period['end'],
                'expectedSettlementDate' => $expectedSettlementDate,
                'actualSettelementDate' => $result['settlementDate'],
    ...
    public function getListBy($params)
    {
        ...
        $qb->select("p")
            ->from('UtilBundle:PaymentGatewayWeekly', 'p');
     ...
     * payment_gateway_weekly.start_period <= bank_settlement_upload_line.post_date <=payment_gateway_weekly.end_period
     */
